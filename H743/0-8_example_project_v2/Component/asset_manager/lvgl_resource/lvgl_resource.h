...
typedef enum {
  RES_IMG_START = 0,
  RES_IMG_TEST = RES_IMG_START,
  RES_IMG_WALLPAPER_DEFAULT,
  RES_IMG_ICON_WIFI,
  RES_IMG_ICON_BRIGHT,
  ...
  RES_FONT_START,
  RES_FONT_TEST = RES_FONT_START,
  RES_FONT_MAX,

  RES_AUDIO_START,
  RES_AUDIO_TEST = RES_AUDIO_START,
  RES_AUDIO_MAX,

  RES_COUNT_MAX
} res_id_t;

#define RES_IMG_COUNT (RES_IMG_MAX - RES_IMG_START)
#define RES_FONT_COUNT (RES_FONT_MAX - RES_FONT_START)
#define RES_AUDIO_COUNT (RES_AUDIO_MAX - RES_AUDIO_START)
