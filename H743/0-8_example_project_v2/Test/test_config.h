...
#define ENABLE_TEST_MQTT 0
#define ENABLE_TEST_SNTP 0

#define ENABLE_TEST_ASSET_MANAGER 0
#define ENABLE_TEST_STORAGE 0
#define ENABLE_TEST_VFS 0
#define ENABLE_TEST_SETTING 0

#define ENABLE_TEST_LVGL_BASE 1
#define ENABLE_TEST_LVGL_RES 0
#define ENABLE_TEST_LVGL_BENCHMARK 1
